-- ============================================================
-- SQL GESTAO DE PROJETOS - Starken & Alpha
-- Baseado no PRD_GESTAO_PROJETOS.md Secao 9
-- Data: 2026-03-17
-- ============================================================
...
INSERT INTO users (name, email, role, pin_hash, avatar_color) VALUES
  ...
  ('Bruna',    NULL, 'editor',   '1111', '#ec4899'),
  ('Emilly',   NULL, 'editor',   '2222', '#f59e0b'),
  ('Marina',   NULL, 'editor',   '3333', '#06b6d4');
...
INSERT INTO clients_v2 (space_id, name, segment, responsible_id) VALUES
  ...
  -- Bruna
  ((SELECT id FROM spaces WHERE name = 'Starken'), 'The Garrison',            'Eventos',                (SELECT id FROM users WHERE name = 'Bruna')),
  ((SELECT id FROM spaces WHERE name = 'Starken'), 'New Service',             'Industria',              (SELECT id FROM users WHERE name = 'Bruna')),
  -- Emilly
  ((SELECT id FROM spaces WHERE name = 'Starken'), 'Academia Sao Pedro',      'Academia',               (SELECT id FROM users WHERE name = 'Emilly')),
  -- Marina
  ((SELECT id FROM spaces WHERE name = 'Starken'), 'Melhor Visao',            'Clinica Otica',          (SELECT id FROM users WHERE name = 'Marina'));
...
INSERT INTO clients_v2 (space_id, name, segment, responsible_id) VALUES
  -- Bruna
  ((SELECT id FROM spaces WHERE name = 'Alpha'), 'Mestre do Frango',    'Gastronomia', (SELECT id FROM users WHERE name = 'Bruna')),
  ((SELECT id FROM spaces WHERE name = 'Alpha'), 'Pizzaria do Nei',     'Gastronomia', (SELECT id FROM users WHERE name = 'Bruna')),
  ((SELECT id FROM spaces WHERE name = 'Alpha'), 'Super Duper',         'Gastronomia', (SELECT id FROM users WHERE name = 'Bruna')),
  ((SELECT id FROM spaces WHERE name = 'Alpha'), 'WorldBurguer',        'Gastronomia', (SELECT id FROM users WHERE name = 'Bruna')),
  ((SELECT id FROM spaces WHERE name = 'Alpha'), 'Saporito Pizzaria',   'Gastronomia', (SELECT id FROM users WHERE name = 'Bruna')),
  ((SELECT id FROM spaces WHERE name = 'Alpha'), 'Fratellis Pizzaria',  'Gastronomia', (SELECT id FROM users WHERE name = 'Bruna')),
  -- Emilly
